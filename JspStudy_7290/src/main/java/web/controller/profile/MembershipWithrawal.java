...
/**
 * Servlet implementation class MembershipWithrawal
 */
@WebServlet("/profile/delete")
public class MembershipWithrawal extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(result == true ) {
			session.invalidate(); //세션을 강제종료 시키는것
			response.sendRedirect("/JspStudy_7290/auth/signin");
		}
	}
